                        ...
                        <div class="card">
                            <div class="card-body">
                                ...
                                <form id="FrmCategoria">
                                    <div class="row mt-3">
                                        <div class="from-group col-sm-9 col-12">
                                            <input type="text" id="txtNombreCategoria" name="txtNombreCategoria" class="from-control form-control-sm" placeholder="Nombre">
                                        </div>
                                ...
                                <div class="row">
                                    <div class="col-sm-3 col-12">
                                        <select class="from-control form-control-sm" id="sizePAgeCategoria" name="sizePAgeCategoria">
